...
from .dlr_deterministic_res import ValDlrResPRM, STEPS as CC_STEPS


@model(steps=CC_STEPS)
class _ActiveLifeRESClaimCostModel(ValDlrResPRM):
...
@model(steps=STEPS)
class ValAlrResPRM(ValAlrBasePBM):
...
@model
class ProjAlrResPRM(ValAlrBasePBM):
    pass
