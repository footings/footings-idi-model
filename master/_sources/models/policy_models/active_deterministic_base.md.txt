...
```{eval-rst}
.. autoclass:: footings_idi_model.policy_models.AValBasePMD
```
...
```{code-cell} ipython3
import pandas as pd
from footings_idi_model.policy_models import AValBasePMD
...
The audit file can be downloaded {download}`here.<./Audit-AValBasePMD.xlsx>`
